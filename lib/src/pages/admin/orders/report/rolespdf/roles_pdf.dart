...
import 'package:jabes/src/pages/admin/orders/report/rolespdf/roles_pdf_controller.dart';
import 'package:open_file/open_file.dart';
import 'package:path_provider/path_provider.dart';

import '../../../../../utils/my_colors.dart';

class RolesPDF extends StatefulWidget {
  const RolesPDF({super.key});

  @override
  State<RolesPDF> createState() => _RolesPDFState();
}

class _RolesPDFState extends State<RolesPDF> {
  RolesPDFController _con = new RolesPDFController();
  Uint8List? _pdfBytes;
    ...
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () async {
          ...
          List<Rol> roles = await _con.getAllrol();

          // Generar el PDF
          Uint8List pdfBytes = await _con.generatePdfBytes(roles);
